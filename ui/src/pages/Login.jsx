      ...
      <div className="gs-login-sidebar">
        ...
        <div className="gs-login-evidence-grid">
          ...
          <div className="gs-login-evidence-card">
            <div className="gs-login-card-title">
              <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/></svg>
          ...
          {/* System Console Code Snippet (Terminal Window Style) */}
          <div className="gs-login-evidence-card wide">
            <div className="gs-terminal-window">
              <div className="gs-terminal-header">
                <div className="gs-terminal-controls">
                  <span className="gs-terminal-dot close"></span>
                  <span className="gs-terminal-dot minimize"></span>
                  <span className="gs-terminal-dot expand"></span>
                </div>
                <span className="gs-terminal-title">delta_log.json</span>
              </div>
...
{`{
  "commitInfo": {
    ...
    "clientVersion": "delta-spark_2.12-3.1.0"
      ...
      {/* Right Panel: Left-Aligned Admin Authentication Form in Card */}
